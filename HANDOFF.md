...
0c. **Duo-offerte automatische mail (vraag Daimy 6 juli)**: Daimy wil dat klanten de duo-offerte automatisch per mail krijgen. Nog geen werkend verzendkanaal: SMTP-script heeft geen wachtwoord, Graph-token is alleen-lezen via browserlogin. Wacht op Daimy: verzendaccount (joey@/daimy@ SMTP-wachtwoord of Trengo-mailkanaal) + akkoord concepttekst.
