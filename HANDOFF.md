...
- VOORBEELD-OPDRACHT NU #1316 (uuid in scratch voorbeeld-uuid.txt, external_id voorbeeld-meetbon-1004; #1313 verwijderd): beschrijving 1 regel, alles in de velden. Script: scratch planado-voorbeeld2.mts. Wacht op Daimy: is dit het detailsvak? Dan automatische vulling bouwen (meetbon compleet → montage-opdracht matchen op klant/adres → velden vullen).
