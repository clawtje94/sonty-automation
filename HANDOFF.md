...
- 16-09 avond: Daimy vroeg 'weet je zeker dat alles compleet is' → nee. Controle vond dat de filter-lezer bij zware filters (0,6-0,85 s laadtijd, lijst intussen verborgen) 'leeg' las → kapkleuren-lijst is groter dan 550. Lezer aangepast (lezen na 950 ms, leeg pas geloven na 2,2 s). Bezig: hercontrole grote lijsten per product (tag recheck2), daarna structurele varianten (Uitvoering, Type armen, Doek, Kapsoort, geleiders, schermmodel, Type screen, montage). Rapport doet unie van lijsten over alle runs.
