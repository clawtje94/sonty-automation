...
5. ⏳ Fact-check: 4 sonnet-subagents checken 44 blogs + vaste pagina's tegen eigen boeken (trengo-kennisbank, roma-prijsstructuur, unilux). Regels Daimy: externe feiten NOOIT van concurrent-zonweringssites, alleen nieuws/instituut + bronvermelding; garantiejaren altijd flaggen (nog niet vastgesteld).
