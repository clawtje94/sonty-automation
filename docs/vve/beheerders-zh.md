# VvE-beheerkantoren Zuid-Holland — maillijst (v1, 2026-07-30)
...
- Provesta (pro-vesta.nl) — Rotterdam/Den Haag/Zoetermeer (site blokkeert bots; handmatig checken)
- ALPHAZ — Zoetermeer, Rijswijk, Den Haag, Delft, Leiden
- Holland VvE Beheer — Rotterdam, ZH + West-Brabant
- 24/7 VvE Beheer B.V.
- Landelijke spelers met ZH-portefeuille om aan te vullen: MVGM VvE, Newomij VvE Beheer, VvE Metea

## Aanpak per beheerder

Mail aan info@ met raamvoorstel: Sonty als vaste zonweringspartner voor hun
portefeuille — gratis protocol per gebouw, één loket voor alle eigenaren-aanvragen
(scheelt hén werk), vaste prijzen, 3/5/7 garantie, rapportage per VvE. Opvolgen
per telefoon na 5 werkdagen. T&T eerst: buurman-verhaal, evt. gewoon langsgaan.

## Spelregels e-mail

- VvE's en beheerders zijn rechtspersonen: koude zakelijke mail aan algemene
