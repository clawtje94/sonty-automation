...
- V100 — Noor — sinds 29-8 — Sjoerd-vakantie t/m 11 sept, tempo/inmeter-keuze — VERSTUURD, open
- V101 — Noor — sinds 29-8 — Prijs-kruiscontrole site kapot (ENOENT) — VERSTUURD, open
- V102 — Lars+Isa — sinds 29-8 — Reviews-sync mist API-key — VERSTUURD, open
- V103 — Lars — sinds 29-8 — Seo-agent activeren — nog niet gestuurd
