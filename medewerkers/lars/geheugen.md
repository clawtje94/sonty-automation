# Geheugen Lars (Hoofd Commercie)

## Vaste afspraken / methode
- Conversie altijd: noemer = alle rijen met datum, teller = bedrag in inkoop, per tabblad. Nooit andere noemer.
- Prijsvoorstellen en kortingsbeleid: nooit zelf, altijd vraag aan Daimy.
- Max 3 delegaties per dag via `node scripts/brein-sessie.js opdracht <slug> "<tekst>"`.
