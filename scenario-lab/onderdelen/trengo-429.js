// Scenario-lab: 429-ALARMREGEL (opdracht Isa 31-08). Orakel: O1 alarm alléén bij >= 30 429's binnen 15 min;
...
const dims = [
  { naam: 'aantal', waarden: [{ label: '0', n: 0 }, { label: '29', n: 29 }, { label: '30', n: 30 }, { label: '40', n: 40 }] },
