...
async function planningRolVoor(t, rows) {
  ...
  const context = [
    ...
    '- Dit is het EERSTE beschikbare moment; eerder kan op dit moment NIET (het is drukker dan we willen door vakanties en de bouwvak; de inmeters werken maandag t/m donderdag overdag; Engelstalige klanten meet alleen Sjoerd of Patrick (Patrick vanaf 21 september)). Zeg dat eerlijk, beloof geen eerdere datum.',
