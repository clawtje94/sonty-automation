...
async function main() {
  ...
  if (MAAK_AANBOD && aanbod.length) {
    ...
    await planningTelegram(`Inmeet-aanbod voor ${item.summary} staat klaar (24u geldig). Dit is de link die de klant zou krijgen — kies zelf een tijd om de keten te testen:
${url}`);
  }
}
